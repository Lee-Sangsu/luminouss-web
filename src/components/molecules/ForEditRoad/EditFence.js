...
import WaterQuestions from 'components/molecules/ForAddRoad/3SafeFence/WaterQuestions';
import FourQ from 'components/molecules/ForAddRoad/3SafeFence/FourQ';
const EditFence = ({env}) => {
    // 기존에 뭘 체크했는지까지 나와야 함.
    if (env === '천변' || env === '강변') {
        return (
