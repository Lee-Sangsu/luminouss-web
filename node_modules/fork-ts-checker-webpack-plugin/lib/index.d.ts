...
declare class ForkTsCheckerWebpackPlugin {
    ...
    static getCompilerHooks(compiler: any): Record<import("fork-ts-checker-webpack-plugin/lib/hooks").ForkTsCheckerHooks, import("tapable").SyncHook<any, any, any> | import("tapable").AsyncSeriesHook<any, any, any>>;
